defmodule WorldCupTracker.Matrix.Trailer do
  @moduledoc """
  Serializes render regions (see `WorldCupTracker.Matrix.Regions`) into the
  ...
  and gamma match.
  """
  alias WorldCupTracker.Matrix.{Framebuffer, Font, Rgb565}
