defmodule WorldCupTracker.Matrix.Regions do
  @moduledoc """
  Helpers that either draw text inline or record a *region* on the framebuffer
  for the trailer (`WorldCupTracker.Matrix.Trailer`). A region is the contract the
  ...
  """
  alias WorldCupTracker.Matrix.{Framebuffer, Font}
